...
class ServerThread extends Thread { 
    ...
    public int filesize = 6230716;

    // server thread to keep connection open and accept it from client
    ...
    // to keep message in streamin pipeline 
...
// ruunable thread for client to client communication
